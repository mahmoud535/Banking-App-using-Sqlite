...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into user_info values(1, 'mahmoud', 'mahmoud@gmail.com','9876543210', 'XXXXXX0010', 'ABCD1234','10000.24')");
        db.execSQL("insert into user_info values(2, 'Ali', 'Ali@gmail.com', '1234567890','XXXXXX0011', 'PQRS1234','5000.45')");
        db.execSQL("insert into user_info values(3, 'Ahmed', 'Ahmed@gmail.com', '7410852963','XXXXXX0012', 'ABCD1234','7000.05')");
        ...
        db.execSQL("insert into user_info values(6, 'jak', 'jak@gmail.com', '3216549870','XXXXXX0015', 'LMNO1234','5000.00')");
        db.execSQL("insert into user_info values(7, 'wael', 'wael@gmail.com', '7539514682','XXXXXX0016', 'ABCD1234','3000.50')");
        db.execSQL("insert into user_info values(8, 'mona', 'mona@gmail.com','1230456789', 'XXXXXX0017', 'EFGH1234','11000.45')");
        db.execSQL("insert into user_info values(9, 'tamer', 'tamer@gmail.com', '9876543210','XXXXXX0018', 'ABCD1234','5000.55')");
        db.execSQL("insert into user_info values(10, 'Alaa', 'Alaa@gmail.com', '7854269098','XXXXXX0019', 'KTVP1234','9000.45')");
